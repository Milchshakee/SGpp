 ...
 * http://www.nrbook.com/a/bookcpdf/c2-4.pdf was used. Some odd Fileopen® plugin is needed to open
 * that file ... sorry for that! the picture depicts all needed variables in oder to perform the
 * transformation: \image html prewavelets_hierarch.png "This picture shows all involved gridpoints
